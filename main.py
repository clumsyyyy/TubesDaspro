...
def main_admin():
    print("\n[ADMIN CONTROL PANEL or something idk]\n")
    print("Perintah: ")
    print("1. Cari rarity (carirarity)")
    print("2. Cari tahun (caritahun)")
    print("3. Tambah item (tambahitem)")
    print("4. Hapus item (hapusitem)")
    print("5. Ubah jumlah (ubahjumlah)")
    command = input()
